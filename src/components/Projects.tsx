    ...
    <section id="projects" className="relative z-10 w-full max-w-7xl mx-auto px-6 py-24">
      ...
      >
        {projects.map((project, index) => (
          ...
          >
            {/* Image Placeholder */}
            <div className={`h-52 w-full bg-gradient-to-br ${project.gradient} relative overflow-hidden flex items-center justify-center`}>
              <div className="absolute inset-0 backdrop-blur-[2px]"></div>
              {/* Abstract glowing shape inside placeholder */}
              <div className="w-32 h-32 rounded-full bg-white/10 blur-2xl absolute"></div>
            </div>
