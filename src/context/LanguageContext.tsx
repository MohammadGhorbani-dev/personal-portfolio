...
const dictionary = {
  ...
  fa: {
    ...
    'hero.desc': 'من دانشجوی مهندسی کامپیوتر هستم که عاشق دنیای کامپیوتره؛ از کدنویسی و سخت‌افزار گرفته تا ساخت ابزارهایی که کارهای روزمره رو برای اطرافیانم ساده‌تر می‌کنه. همیشه دنبال تجربه‌های جدیدم و در زمینه‌های مختلفی از پشتیبانی گرفته تا دندانسازی فعالیت داشتم که باعث شده دید بازتری به حل مسائل داشته باشم. در اوقات فراغتم بیشتر گیم می‌زنم، موزیک گوش میدم یا با تکنولوژی‌های جدید کار می‌کنم. همیشه از هم‌صحبتی و همکاری با افراد جدید تو زمینه‌های مختلف خوشحال میشم!',
